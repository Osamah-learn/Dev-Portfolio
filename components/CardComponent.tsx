        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4">
            ...
            <div className="flex flex-col items-center justify-center p-4 bg-white rounded-lg shadow">
                ...
                <ul className="flex flex-row mt-4 space-x-2">
                    <li>
                        <a onClick={() => window.open('mailto:osku@osamah-dev.tech')} className="flex items-center justify-center w-8 h-8 text-gray-800 border border-gray-800 rounded-full">
                            <AiOutlineMail className="cursor-pointer" />

                        </a>
                    </li>
                    <li>
                        <a href="tel:+15555551212" className="flex items-center justify-center w-8 h-8 text-gray-800 border border-gray-800 rounded-full">
                            <AiOutlinePhone />
                        </a>
                    </li>
                </ul>
