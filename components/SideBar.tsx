...
export const SideBar = () => {
    return (
        <div>
            ...
            <p className="flex items-center justify-center px-2 py-1 my-3 rounded-full bg-gray-50">
                Junior Full-Stack Developer</p>
            <a className="flex items-center justify-center px-2 py-1 my-3 rounded-full bg-gray-50" href="https://github.com/" download="https://github.com">
            ...
            <div className="py-4 my-5 bg-gray-50">
            ...
            <button type="button" className="w-8/12 px-4 py-2 my-2 text-white rounded-full bg-gradient-to-r from-green-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500">Toggle Theme</button>
        </div>
    )
}
